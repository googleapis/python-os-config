...
def test_execute_patch_job(transport: str = 'grpc', request_type=patch_jobs.ExecutePatchJobRequest):
    ...
    with mock.patch.object(
            type(client._transport.execute_patch_job),
            '__call__') as call:
...
async def test_execute_patch_job_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.execute_patch_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_patch_job(transport: str = 'grpc', request_type=patch_jobs.GetPatchJobRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_patch_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = patch_jobs.PatchJob(
            name='name_value',
...
async def test_get_patch_job_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.get_patch_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(patch_jobs.PatchJob(
            name='name_value',
...
def test_cancel_patch_job(transport: str = 'grpc', request_type=patch_jobs.CancelPatchJobRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_patch_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = patch_jobs.PatchJob(
            name='name_value',
...
async def test_cancel_patch_job_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.cancel_patch_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(patch_jobs.PatchJob(
            name='name_value',
...
def test_list_patch_jobs(transport: str = 'grpc', request_type=patch_jobs.ListPatchJobsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_patch_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_patch_job_instance_details(transport: str = 'grpc', request_type=patch_jobs.ListPatchJobInstanceDetailsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_patch_job_instance_details),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_patch_job_instance_details_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page in (await client.list_patch_job_instance_details(request={})).pages:
            pages.append(page)
        for page, token in zip(pages, ['abc','def','ghi', '']):
            assert page.raw_page.next_page_token == token
...
def test_create_patch_deployment(transport: str = 'grpc', request_type=patch_deployments.CreatePatchDeploymentRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.create_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_create_patch_deployment_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.create_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_patch_deployment(transport: str = 'grpc', request_type=patch_deployments.GetPatchDeploymentRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = patch_deployments.PatchDeployment(
            name='name_value',
...
async def test_get_patch_deployment_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.get_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(patch_deployments.PatchDeployment(
            name='name_value',
...
def test_list_patch_deployments(transport: str = 'grpc', request_type=patch_deployments.ListPatchDeploymentsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_patch_deployments),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_patch_deployment(transport: str = 'grpc', request_type=patch_deployments.DeletePatchDeploymentRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_patch_deployment_async(transport: str = 'grpc_asyncio'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._client._transport.delete_patch_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
