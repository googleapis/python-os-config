...
class Inventory(proto.Message):
    ...
    class Item(proto.Message):
        ...
        origin_type = proto.Field(proto.ENUM, number=2,
        ...
        installed_package = proto.Field(proto.MESSAGE, number=6, oneof='details',
            message='Inventory.SoftwarePackage',
        )

        available_package = proto.Field(proto.MESSAGE, number=7, oneof='details',
            message='Inventory.SoftwarePackage',
        )
    ...
    class SoftwarePackage(proto.Message):
        ...
        yum_package = proto.Field(proto.MESSAGE, number=1, oneof='details',
            message='Inventory.VersionedPackage',
        )

        apt_package = proto.Field(proto.MESSAGE, number=2, oneof='details',
            message='Inventory.VersionedPackage',
        )

        zypper_package = proto.Field(proto.MESSAGE, number=3, oneof='details',
            message='Inventory.VersionedPackage',
        )

        googet_package = proto.Field(proto.MESSAGE, number=4, oneof='details',
            message='Inventory.VersionedPackage',
        )

        zypper_patch = proto.Field(proto.MESSAGE, number=5, oneof='details',
            message='Inventory.ZypperPatch',
        )

        wua_package = proto.Field(proto.MESSAGE, number=6, oneof='details',
            message='Inventory.WindowsUpdatePackage',
        )

        qfe_package = proto.Field(proto.MESSAGE, number=7, oneof='details',
            message='Inventory.WindowsQuickFixEngineeringPackage',
        )

        cos_package = proto.Field(proto.MESSAGE, number=8, oneof='details',
            message='Inventory.VersionedPackage',
        )
    ...
    class WindowsUpdatePackage(proto.Message):
        ...
        categories = proto.RepeatedField(proto.MESSAGE, number=3,
        ...
        last_deployment_change_time = proto.Field(proto.MESSAGE, number=10,
            message=timestamp.Timestamp,
        )
    ...
    class WindowsQuickFixEngineeringPackage(proto.Message):
        ...
        install_time = proto.Field(proto.MESSAGE, number=5,
            message=timestamp.Timestamp,
        )

    os_info = proto.Field(proto.MESSAGE, number=1,
        message=OsInfo,
    )

    items = proto.MapField(proto.STRING, proto.MESSAGE, number=2,
        message=Item,
    )
