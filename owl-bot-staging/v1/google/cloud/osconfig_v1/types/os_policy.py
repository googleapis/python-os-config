...
class OSPolicy(proto.Message):
    ...
    Attributes:
        ...
        resource_groups (Sequence[google.cloud.osconfig_v1.types.OSPolicy.ResourceGroup]):
    ...
    class ResourceGroup(proto.Message):
        ...
        Attributes:
            inventory_filters (Sequence[google.cloud.osconfig_v1.types.OSPolicy.InventoryFilter]):
            ...
            resources (Sequence[google.cloud.osconfig_v1.types.OSPolicy.Resource]):
