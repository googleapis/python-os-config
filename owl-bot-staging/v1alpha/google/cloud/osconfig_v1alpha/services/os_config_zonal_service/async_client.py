...
class OsConfigZonalServiceAsyncClient:
    ...
    async def get_instance_os_policies_compliance(self,
        ...
        """
        warnings.warn("OsConfigZonalServiceAsyncClient.get_instance_os_policies_compliance is deprecated",
            DeprecationWarning)
    ...
    async def list_instance_os_policies_compliances(self,
        ...
        """
        warnings.warn("OsConfigZonalServiceAsyncClient.list_instance_os_policies_compliances is deprecated",
            DeprecationWarning)
